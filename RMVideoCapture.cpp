...
RMVideoCapture::RMVideoCapture(const char * device, unsigned int size_buffer) : video_path(device) {
...
//    std::cout << "current buffr idx: " << buffer_idx << std::endl;
...
bool RMVideoCapture::setVideoFPS(unsigned int fps){
